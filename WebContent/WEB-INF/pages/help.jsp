...
<ui:columns>
	...
	<jsp:attribute name="left_column">
			...
			<div class="text_info">
                ...
                <h4>Выбор города</h4>
                <h6>
                    <img src="${myContext}/media/css/images/map.png" height="150px" width="200px"
                         style="float: right;"/>
                    В сервисе предоставляется возможность выбора города. На данный момент доступны лишь три города:
                    Харьков, Мелитополь и Киев.
                    В дальнейшем данный список будет расширяться.
                </h6>
                <h4>Выбор точек "ОТ" и "ДО"</h4>
                <h6>
                    <img src="${myContext}/media/css/images/mapping_places.jpg" height="150px" width="200px"
                         style="float: left;"/>
                ...
                <h6>
                    <img src="${myContext}/media/css/images/choose_vec.jpg" height="150px" width="200px"
                         style="float: right;"/>
                    После того, как заданы все настройки, сервис Вам предложит оптимальные маршруты. Среди предложенных
                    маршрутов
