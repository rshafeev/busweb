...
<table id="cways_menu_discount" class="menu_options_table3">
	<tbody>
		<tr>
			...
			<td class="padding_right">
				<label for="cways_menu_discount_tram_label" id="tram_label"  title=""><spring:message code="basic.discount_tram" text="default text" /></label>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<label for="lgot" id="cways_menu_discount_pref_label" style="margin-left: 5px; " title=""><spring:message code="basic.discount_pref" text="default text" /></label>
			</td>
			<td>
			...
			<td>
				<label for="troll" id="cways_menu_discount_trolley_label" style="margin-left: 5px; " title=""><spring:message code="basic.discount_trolley" text="default text" /></label>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<label for="stud" id="cways_menu_discount_other_label" style="margin-left: 5px; " title=""><spring:message code="basic.discount_other" text="default text" /></label>
			</td>
			<td>
			...
			<td>
				<label for="troll" id="cways_menu_discount_metro_label" style="margin-left: 5px; " title=""><spring:message code="basic.discount_metro" text="default text" /></label>
			</td>		
		</tr>
	</tbody>
</table>
