...
cityways.event = {
    ...
    addListener: function (object, evt, callback) {
        ...
        else if (cityways.event.listeners.get(object)[evt] == undefined) {
...
cityways.page.search.SettingsPanel = cityways.Class({
    ...
    members: {
        ...
        enableRouteTypeBtn: function (routeType, val) {
            ...
            } else if (routeType == "auto" && val == false) {
            ...
            else if (routeType != "auto" && val == true && val == this.isEnabledRouteTypeBtn("auto") == true) {
