...
public class NavigationModel {
	...
	public static ArrayList<LinkModel> getNavigationLinks(
		...
		homeLink.setLabel(messageSource.getMessage("navigation.home", null,
				currentLocale));
		...
		routesLink.setLabel(messageSource.getMessage("navigation.routes", null,
				currentLocale));
		...
		programmsLink.setLabel(messageSource.getMessage("navigation.help", null,
				currentLocale));
		...
		aboutLink.setLabel(messageSource.getMessage("navigation.about", null,
				currentLocale));
